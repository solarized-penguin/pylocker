...
from app.routers.utils import upload_file_generator, calculate_checksums
...
async def upload_file(
    ...
    for file in upload_files.files:
        ...
        file_read: FileRead = await files_repository.create_file(
            loid, file.filename, offset, '', user_info
        )
        results.append(file_read)

    background_tasks.add_task(
        calculate_checksums,
        [file.filename for file in upload_files.files],
